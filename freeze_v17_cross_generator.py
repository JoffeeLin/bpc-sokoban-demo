...
SENSORS=((4,None,1,5,None,0,3,None,2),(None,1,4,None,2,5,None,0,None,3),
    (3,None,5,0,None,None,1,4,None,2,None),(None,0,4,None,2,None,5,1,None,None,3,None))
ACTIONS=((3,None,0,2,1),(2,None,1,3,None,0),(None,0,3,None,1,None,2),(1,None,3,0,None,2,None,None))
KINDS=((5,3,4),(4,5,3,4),(3,4,5,3,4),(5,3,4,5,3,4))
...
def main():
    config={'train_seed':121010,'reference_seed':173010,'target_seeds':[[173110+i*10+j for j in range(4)] for i in range(4)],
        ...
        'holdout_seed':173510,'worlds_per_family':12,'eval_seeds':[173610,173710],
        'episodes_per_map':24,'step_budget':64,'random_binding_seed':173810}
