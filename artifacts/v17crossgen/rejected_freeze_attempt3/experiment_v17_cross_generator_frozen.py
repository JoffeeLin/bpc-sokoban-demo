...
from bpc_cross_generator_v17 import (LabWorld,VariableBoundPolicy,collect_variable,evaluate_variable,
    infer_relational_support_binding,inverse,lab_distance,same_cell_counts,same_cell_log_probability)
...
def main():
    ...
    source='\n'.join(inspect.getsource(x) for x in (projected_support,same_cell_counts,same_cell_log_probability,infer_relational_support_binding,OpenInterfaceStats.observe,OpenActionStats.observe,infer_action_subset,VariableBoundPolicy.probabilities))
